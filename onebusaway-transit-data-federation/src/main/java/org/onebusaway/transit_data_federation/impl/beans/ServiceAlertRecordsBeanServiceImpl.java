...
class ServiceAlertRecordsBeanServiceImpl implements ServiceAlertsBeanService {

  private ServiceAlertRecordsService _serviceAlertRecordsService;

  @Autowired
  public void setServiceAlertsService(ServiceAlertRecordsService serviceAlertRecordsService) {
    _serviceAlertRecordsService = serviceAlertRecordsService;
  }
  ...
  public ServiceAlertBean createServiceAlert(String agencyId,
    ...
    serviceAlertRecord = _serviceAlertRecordsService.createOrUpdateServiceAlert(
        serviceAlertRecord);
  ...
  public void updateServiceAlert(ServiceAlertBean situationBean) {
    ...
    ServiceAlertRecord dbServiceAlertRecord = _serviceAlertRecordsService.getServiceAlertForId(id);
    
    if(dbServiceAlertRecord != null){
  	  serviceAlertRecord.setCopy(dbServiceAlertRecord.isCopy());
    }
    
    _serviceAlertRecordsService.createOrUpdateServiceAlert(serviceAlertRecord);
  }
  ...
  public ServiceAlertBean copyServiceAlert(String agencyId,
	  ...
	  serviceAlertRecordCopy = _serviceAlertRecordsService.copyServiceAlert(serviceAlertRecordCopy);
	  return getServiceAlertAsBean(serviceAlertRecordCopy);  
  }

  @Override
  public void removeServiceAlert(AgencyAndId situationId) {
    _serviceAlertRecordsService.removeServiceAlert(situationId);
  }

  @Override
  public ServiceAlertBean getServiceAlertForId(AgencyAndId situationId) {
    ServiceAlertRecord serviceAlert = _serviceAlertRecordsService.getServiceAlertForId(situationId);
  ...
  public List<ServiceAlertBean> getServiceAlertsForFederatedAgencyId(
      String agencyId) {
    List<ServiceAlertRecord> serviceAlerts = _serviceAlertRecordsService.getServiceAlertsForFederatedAgencyId(agencyId);
  ...
  public void removeAllServiceAlertsForFederatedAgencyId(String agencyId) {
    _serviceAlertRecordsService.removeAllServiceAlertsForFederatedAgencyId(agencyId);
  }

  @Override
  public List<ServiceAlertBean> getServiceAlertsForStopId(long time,
      AgencyAndId stopId) {
    List<ServiceAlertRecord> serviceAlerts = _serviceAlertRecordsService.getServiceAlertsForStopId(
        time, stopId);
    return list(serviceAlerts);
  }
  ...
  public List<ServiceAlertBean> getServiceAlertsForStopCall(long time,
    ...
    List<ServiceAlertRecord> serviceAlerts = _serviceAlertRecordsService.getServiceAlertsForStopCall(
  ...
  public List<ServiceAlertBean> getServiceAlertsForVehicleJourney(long time,
    ...
    List<ServiceAlertRecord> serviceAlerts = _serviceAlertRecordsService.getServiceAlertsForVehicleJourney(
  ...
  public List<ServiceAlertBean> getServiceAlerts(SituationQueryBean query) {
    List<ServiceAlertRecord> serviceAlerts = _serviceAlertRecordsService.getServiceAlerts(query);
    return list(serviceAlerts);
  }
