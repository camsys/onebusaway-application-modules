...
public interface TripModsStopCreationService {
    /**
     * Add new stops, returning the list of successfully added stops
     *
     * @param stops to create
     * @return list of successfully created stops
     */
    AddedStops createAddedStops(List<Stop> stops);

    void addStopsToSchedule(AddedStops addedStops);
}
