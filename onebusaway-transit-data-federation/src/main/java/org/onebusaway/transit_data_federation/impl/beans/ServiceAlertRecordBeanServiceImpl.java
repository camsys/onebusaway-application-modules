...
class ServiceAlertRecordBeanServiceImpl implements ServiceAlertsBeanService {
    ...
    public ServiceAlertBean createServiceAlert(String agencyId,
        ...
        serviceAlertRecord = _serviceAlertsRecordService.createOrUpdateServiceAlert(
                serviceAlertRecord);
    ...
    public void updateServiceAlert(ServiceAlertBean situationBean) {
        ...
        ServiceAlertRecord dbServiceAlertRecord = _serviceAlertsRecordService.getServiceAlertForId(id);

        if(dbServiceAlertRecord != null){
            serviceAlertRecord.setCopy(dbServiceAlertRecord.isCopy());
        }

        _serviceAlertsRecordService.createOrUpdateServiceAlert(serviceAlertRecord);
    }
    ...
    public ServiceAlertBean copyServiceAlert(String agencyId,
        ...
        serviceAlertRecordCopy = _serviceAlertsRecordService.copyServiceAlert(serviceAlertRecordCopy);
        return getServiceAlertAsBean(serviceAlertRecordCopy);
    }

    @Override
    public void removeServiceAlert(AgencyAndId situationId) {
        _serviceAlertsRecordService.removeServiceAlert(situationId);
    }

    @Override
    public ServiceAlertBean getServiceAlertForId(AgencyAndId situationId) {
        ServiceAlertRecord serviceAlert = _serviceAlertsRecordService.getServiceAlertForId(situationId);
    ...
    public List<ServiceAlertBean> getServiceAlertsForFederatedAgencyId(
            String agencyId) {
        List<ServiceAlertRecord> serviceAlerts = _serviceAlertsRecordService.getServiceAlertsForFederatedAgencyId(agencyId);
    ...
    public void removeAllServiceAlertsForFederatedAgencyId(String agencyId) {
        _serviceAlertsRecordService.removeAllServiceAlertsForFederatedAgencyId(agencyId);
    }

    @Override
    public List<ServiceAlertBean> getServiceAlertsForStopId(long time,
                                                            AgencyAndId stopId) {
        List<ServiceAlertRecord> serviceAlerts = _serviceAlertsRecordService.getServiceAlertsForStopId(
                time, stopId);
        return list(serviceAlerts);
    }
    ...
    public List<ServiceAlertBean> getServiceAlertsForStopCall(long time,
        ...
        List<ServiceAlertRecord> serviceAlerts = _serviceAlertsRecordService.getServiceAlertsForStopCall(
    ...
    public List<ServiceAlertBean> getServiceAlertsForVehicleJourney(long time,
        ...
        List<ServiceAlertRecord> serviceAlerts = _serviceAlertsRecordService.getServiceAlertsForVehicleJourney(
    ...
    public List<ServiceAlertBean> getServiceAlerts(SituationQueryBean query) {
        List<ServiceAlertRecord> serviceAlerts = _serviceAlertsRecordService.getServiceAlerts(query);
        return list(serviceAlerts);
    }
