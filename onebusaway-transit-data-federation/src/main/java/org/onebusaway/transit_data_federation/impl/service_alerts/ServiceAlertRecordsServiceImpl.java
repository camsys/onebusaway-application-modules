...
@Component
class ServiceAlertRecordsServiceImpl implements ServiceAlertRecordsService {

  private static Logger _log = LoggerFactory.getLogger(ServiceAlertRecordsServiceImpl.class);
	...
	@PreDestroy
	public void stop() {
		_log.info("Stopping ServiceAlertRecordsService");
	}

	/****
	 * {@link ServiceAlertRecordsService} Interface
	 ****/
