...
public class AddedStopsResult {
    private final List<AgencyAndId> failedAddedStopIds = new ArrayList<>();
    private final List<AgencyAndId> successfullyAddedStopIds = new ArrayList<>();
    ...
    public List<AgencyAndId> getFailedAddedStopIds() {
        return Collections.unmodifiableList(failedAddedStopIds);
    }

    public List<AgencyAndId> getSuccessfullyAddedStopIds() {
        return Collections.unmodifiableList(successfullyAddedStopIds);
    }

    public void addSuccessfullyAddedStopId(AgencyAndId stopId) {
        this.successfullyAddedStopIds.add(stopId);
    }

    public void addFailedAddedStopId(AgencyAndId stopId) {
