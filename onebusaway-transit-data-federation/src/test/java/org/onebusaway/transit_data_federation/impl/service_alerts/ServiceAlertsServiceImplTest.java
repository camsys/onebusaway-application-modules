...
@TestPropertySource(properties = {
        "bundlePath = /tmp/foo",
        "serviceAlerts.refreshInterval = 1000"
})
...
public class ServiceAlertsServiceImplTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void setup() throws IOException {
        ...
        ((ServiceAlertsServiceImpl) _service).start();
    }
...
//        assertTrue(alerts.contains(alert4));
    ...
    public void testUpdateServiceAlert() {
        ...
        alert1.setAllAffects(new HashSet<>());
        ...
        alerts = _service.getServiceAlertsForStopId(
                System.currentTimeMillis(), AgencyAndId.convertFromString("2_10020"));
        assertEquals(1, alerts.size());
        assertTrue(alerts.contains(alert1));
    }
    ...
    public void testDBDelete() {
        ...
        _service.sync();
        assertEquals(1, _service.getAllServiceAlerts().size());
