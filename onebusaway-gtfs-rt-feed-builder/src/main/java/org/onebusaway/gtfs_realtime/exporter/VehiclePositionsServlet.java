...
public class VehiclePositionsServlet extends AbstractGtfsRealtimeServlet {
  ...
  private static final Logger _log = LoggerFactory.getLogger(VehiclePositionsServlet.class);
  ...
  protected Message getMessage() {
    ...
    int count = -1;
    if (_provider != null && _provider.getVehiclePositions() != null) {
      count = _provider.getVehiclePositions().getEntityCount();
    }
